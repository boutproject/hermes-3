...
TEST_F(CellAverageTest, ConstantValue) {
  Field3D field{1.0};
  Field3D result =
      cellAverage([](BoutReal) { return 3.0; }, field.getRegion("RGN_NOBNDRY"))(field);
...
TEST_F(CellAverageIntoTest, ConstantValue) {
  ...
  Field3D result;
  cellAverageInto(
      result, [](BoutReal) { return 3.0; }, field.getRegion("RGN_NOBNDRY"), field);
...
TEST_F(CellAverageIntoTest, ConstantField) {
  ...
  Field3D result;
  cellAverageInto(
      result, [](BoutReal val) { return val * 2.0; }, field.getRegion("RGN_NOBNDRY"),
      field);
...
TEST_F(CellAverageIntoTest, MatchesCellAverage) {
  ...
  Field3D expected = cellAverage([](BoutReal ne, BoutReal te) { return ne * te; },
                                 Ne.getRegion("RGN_NOBNDRY"))(Ne, Te);

  Field3D result;
  cellAverageInto(
      result, [](BoutReal ne, BoutReal te) { return ne * te; },
      Ne.getRegion("RGN_NOBNDRY"), Ne, Te);
...
TEST_F(CellAverageIntoTest, WorkspaceReuse) {
  ...
  cellAverageInto(
      result, [](BoutReal v) { return v; }, field_a.getRegion("RGN_NOBNDRY"), field_a);
  ASSERT_TRUE(IsFieldEqual(result, 2.0, "RGN_NOBNDRY"));

  // Second call must overwrite with field_b's values, not keep field_a's.
  cellAverageInto(
      result, [](BoutReal v) { return v; }, field_b.getRegion("RGN_NOBNDRY"), field_b);
