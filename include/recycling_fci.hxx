#pragma once
#ifndef RECYCLING_FCI_H
#define RECYCLING_FCI_H
...
/// 
struct RecyclingFCI : public Component {
  ...
  ///
  RecyclingFCI(std::string name, Options &alloptions, Solver *);
...
namespace {
RegisterComponent<RecyclingFCI> registercomponentrecycling("recycling_fci");
}

#endif // RECYCLING_FCI_H
